...
def download_data_files():
    ...
    files_to_download = {
        ...
        "data/chroma_db.zip": "https://github.com/scribblepear/tankobot-backend/releases/download/v1.0/chroma_db.zip"
    }
        ...
        if not os.path.exists(file_path):
            ...
            try:
                ...
                if file_path.endswith('.zip'):
                    ...
                    import glob
                    extracted_files = glob.glob("data/**/chroma.sqlite3", recursive=True)
                    if extracted_files:
                        print(f"Found database at: {extracted_files[0]}")
